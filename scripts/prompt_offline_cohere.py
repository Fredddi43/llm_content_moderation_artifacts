...
# Model directory - should contain the Cohere model
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "models", "CohereLabs--c4ai-command-a-03-2025")

# Corpus directory containing CSV files
CORPUS_DIR = os.path.join(os.path.dirname(__file__), "..", "corpus", "split")

# Results base directory for output
RESULTS_BASE_DIR = os.path.join(os.path.dirname(__file__), "..", "results_ae", "CohereLabs--c4ai-command-a-03-2025")
