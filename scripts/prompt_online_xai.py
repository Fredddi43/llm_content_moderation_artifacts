...
RESULTS_BASE_DIR = os.path.join(BASE_DIR, "results_ae", "Online", XAI_MODEL)
...
def process_csv_file(csv_file: str, engine: XAILLM, run_number: int, subprompts: Dict[str, str]):
...
def main():
    logging.info("Starting XAI online inference...")
    engine = XAILLM(api_key=XAI_API_KEY, model=XAI_MODEL, base_url=XAI_API_BASE)
