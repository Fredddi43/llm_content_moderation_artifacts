...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "models", "TheBloke--WizardLM-30B-uncensored-AWQ")
CORPUS_DIR = os.path.join(os.path.dirname(__file__), "..", "corpus", "split")
RESULTS_BASE_DIR = os.path.join(os.path.dirname(__file__), "..", "results_ae", "TheBloke--WizardLM-30B-uncensored-AWQ")
