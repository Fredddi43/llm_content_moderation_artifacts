...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "models", "meta-llama--Llama-3.3-70B-Instruct")
CORPUS_DIR = os.path.join(os.path.dirname(__file__), "..", "corpus", "split")
RESULTS_BASE_DIR = os.path.join(os.path.dirname(__file__), "..", "results_ae", "meta-llama--Llama-3.3-70B-Instruct")
...
def main():
    ...
    engine = LLM(model=MODEL_DIR, enforce_eager=True, trust_remote_code=True, tensor_parallel_size=2, max_model_len=100000, gpu_memory_utilization=0.95)
