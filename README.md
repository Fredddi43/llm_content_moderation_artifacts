...
4. **DeBERTa Classifier (Artifact #4)**: Custom classifier to evaluate moderation strength. This is large and therefore hosted on anonymous huggingface: https://huggingface.co/AnonymousNDSSSubmitter12345/Classifier_30k/tree/main
